...
function works(work_id){
    if(work_id)
        ...
        return 'select a.ID, a.NAME_WORKS, b.NAME_USERS, d.NAME_WORK_LEVELS, a.BEGIN_DATE_AT, a.END_DATE_AT, IS_SEEN from gv_works a join gv_users b on a.user_id = b.id join gv_work_levels d on a.work_level_id = d.id';      
}

function work_receive(id){
    return `select a.ID, a.USER_ID, b.name_users as NAME_RECEIVERS, c.name_work_types, a.COMMENT_WORK_RECEIVE, TOTAL_TIME, TOTAL_TIME_CHECK, BEGIN_DATE_AT, END_DATE_AT
...
function add_work(body){
    return `insert into gv_works values(null, ${body.USER_ID}, ${body.WORK_LEVEL_ID}, ${body.WORK_RECEIVE_ID}, ${body.WORK_EVALUTE_ID}, ${body.WORK_ID}, '${body.EVALUTE_COMMENT}', '${body.NAME_WORKS}', '${body.NOTE}',TO_TIMESTAMP('${body.END_DATE_AT}', 'DD/MM/YYYY HH24:MI:SS'), TO_TIMESTAMP('${body.CREATED_AT}', 'DD/MM/YYYY HH24:MI:SS'), TO_TIMESTAMP('${body.UPDATED_AT}', 'DD/MM/YYYY HH24:MI:SS'), ${body.IS_SEEN}, TO_TIMESTAMP('${body.BEGIN_DATE_AT}', 'DD/MM/YYYY HH24:MI:SS'))`;
}

function add_work_receive(body){
    return `INSERT INTO gv_work_receives VALUES (NULL, ${body.WORK_ID}, ${body.USER_ID}, ${body.WORK_TYPE_ID}, ${body.WORK_EVALUTE_ID}, '${body.COMMENT_WORK_RECEIVE}', ${body.TOTAL_TIME}, ${body.TOTAL_TIME_CHECK}, TO_TIMESTAMP('${body.BEGIN_DATE_AT}', 'DD/MM/YYYY HH24:MI:SS'), TO_TIMESTAMP('${body.END_DATE_AT}', 'DD/MM/YYYY HH24:MI:SS'), TO_TIMESTAMP('${body.CREATED_AT}', 'DD/MM/YYYY HH24:MI:SS'), TO_TIMESTAMP('${body.CREATED_AT}', 'DD/MM/YYYY HH24:MI:SS'))`;
}
